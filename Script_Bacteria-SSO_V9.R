...
# One-tailed test
# In females, we consider gyne, q1d, and q9d (Ind), cut., sperma_liq (Tissues) (NO BURSA_COP)
# --> q9d instead of q24d
# Two outliers removed in spermatheca_liq (Gyne and q1d)
...
data <- subset(data, Ind != "q3d" & Ind != "q24d" & Tissue != "seminal_ves_env" & Tissue !=
                 "bursa_cop_env" & Tissue != "bursa_cop_liq" & Tissue != "spermatheca_env")
...
test <- anova.1way(Shannon ~ Tissue, data = sub, nperm = 999)
test
